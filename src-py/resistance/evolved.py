...
class Evolved(Agent):    
    ...
    Hard coded to use data that was evolved over 900 genetic trials.
    '''    

    def __init__(self, name='Evolved'):
        self.name = name

        self.data = { # genes from genes_900.json, Ev0
            "vote_weight": [0,0,0,0.4],
            "proposer_weight": [0,0,0,0.3],
            "vote_threshold": [0.04,-0.11,-0.14,0.8],
            "failable_vote_threshold": [0.47,0.43,0.39,0.86],
            "betray_rate": [0.17,0.49,-0.1,0.61],
            "risky_betray_rate": [0.28,-0.33,-0.34,0.69],
            "opponent_betray_rate": [0.12,0.28,0.04,0.3],
            "spy_vote_failed": [0.41,0.14,-0.17,0.6],
            "spy_vote_success": [-0.21,-0.34,0.18,0.86],
            "spy_propose_failed": [-0.18,-0.4,-0.21,0.09],
            "spy_propose_success": [0.1,-0.03,-0.21,0.34],
            "res_vote_failed": [-0.23,0.33,-0.21,0.58],
            "res_vote_success": [-0.17,-0.08,-0.4,0.17],
            "res_propose_failed": [-0.42,-0.07,-0.17,0.52],
            "res_propose_success": [0.23,0.04,-0.12,0.75]
        }
