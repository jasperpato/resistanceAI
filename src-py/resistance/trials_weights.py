...
def mutate(d_in):
    '''
    Returns a randomly mutated (weights) deepcopy of dictionary.
    '''
    d = deepcopy(d_in)
    for k in ["outcome_weight", "vote_weight", "proposer_weight"]:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        genes = None
        with open('genes_weights.json') as f: genes = json.load(f)
        ...
        with open('genes_weights.json', 'w') as f: json.dump(new_genes, f, indent="")
